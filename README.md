...
Демонстрационная страница — <http://localhost:8000/>: там можно отправить
обращение и увидеть решение системы без curl.
...
| `GET` | `/` | Демонстрационная страница: форма обращения и результат обработки |
...
app/            HTTP API на FastAPI
  static/       демонстрационная страница
